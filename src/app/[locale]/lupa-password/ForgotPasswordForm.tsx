...
export default function ForgotPasswordForm() {
  ...
  return (
    <form action={formAction} className="mt-5 space-y-3">
      ...
      <input name="email" type="email" required placeholder={t("emailPh")} className="w-full rounded-md border border-border bg-background px-3 py-2.5 text-xs outline-none focus:border-primary" />
